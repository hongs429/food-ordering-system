...
import com.food.ordering.system.order.service.domain.entity.Restaurant.Builder;
...
public class OrderApplicationServiceTest {
    ...
    public void setUp() {
        ...
        Restaurant restaurantResponse = Builder.builder()
        ...
        when(restaurantRepository.findRestaurantInformation(
                orderDataMapper.toRestaurant(createOrderCommand))).thenReturn(Optional.of(restaurantResponse));
    ...
    void testCreateOrder() {
        ...
        assertThat(createOrderResponse.getMessage()).isEqualTo("");
    }
    ...
    void testCreateOrderWithWrongTotalPrice() {
        ...
        assertThat(orderDomainException.getMessage()).isEqualTo("Total price: 250.00 is not equal to price for items: 200.00");
    }
